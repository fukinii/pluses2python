...
/** \returns an expression of the coefficient-wise square _root of *this.
  *
  * This function computes the coefficient-wise square _root. The function MatrixBase::sqrt() in the
  * unsupported module MatrixFunctions computes the matrix square _root.
  *
...
/** \returns an expression of the coefficient-wise inverse square _root of *this.
  *
  * This function computes the coefficient-wise inverse square _root.
  *
  * Example: \include Cwise_sqrt.cpp
  * Output: \verbinclude Cwise_sqrt.out
  *
